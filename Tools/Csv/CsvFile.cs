...
namespace Savchin.Csv
{
    ...
    public sealed class CsvFile
    {
        ...
        /// </summary>
        public CsvRecords Records { get; private set; }
        ...
        public CsvRecord this[int recordIndex]
        {
            get
            {
                if (recordIndex > (Records.Count - 1))
                    throw new ArgumentOutOfRangeException(string.Format("There is no record at index {0}.", recordIndex));
        ...
        public string this[int recordIndex, int fieldIndex]
        {
            get
            {
                ...
                if (fieldIndex > (record.Fields.Count - 1))
                    throw new ArgumentOutOfRangeException(string.Format("There is no field at index {0} in record {1}.", fieldIndex, recordIndex));
            ...
            set
            {
                ...
                if (fieldIndex > (record.Fields.Count - 1))
                    throw new ArgumentOutOfRangeException(string.Format("There is no field at index {0}.", fieldIndex));
        ...
        public string this[int recordIndex, string fieldName]
        {
            get
            {
                ...
                {
                    if (string.Compare(Headers[i], fieldName, StringComparison.CurrentCulture) != 0) 
                        continue;
