...
namespace Savchin.Core
{
    ...
    public static class TypeHelper
    {
        ...
        /// <param name="inherits">if set to <c>true</c> [inherits].</param>
        /// <returns></returns>
        public static object GetAttribute(this ICustomAttributeProvider type, Type attributeType, bool inherits = false)
        {
            var attr = type.GetCustomAttributes(attributeType, inherits);
            return attr.IsEmpty() ? null : attr[0];
        }
