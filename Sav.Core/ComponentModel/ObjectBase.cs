...
namespace Savchin.ComponentModel
{
    ...
    public class ObjectBase : INotifyPropertyChanged, IDirtyTracker, ICompositeObject
    {
        ...
        {
            return _child?.OfType<T>() ?? Enumerable.Empty<T>();
        }
        ...
        {
            return SetProperty<T>(ref field, newValue, null, propertyName);
        }
        ...
        {
            return Set(ref field, newValue, null, propertyName);
        }
        ...
        protected bool Set<T>(ref T field, T newValue, Action<T, T> onValueChanged, params string[] propertyName)
        {
            ...
            field = newValue;
            IsDirty = true;
            onValueChanged?.Invoke(previouseValue, newValue);
            OnPropertyChanged(propertyName);
            return true;
        }
