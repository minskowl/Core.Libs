...
namespace Savchin.Text
{
    ...
    public static class StringUtil
    {
        ...
        //    }
        //}
        public static string CapitalizeFirstLatter(string name)
        {
            if (char.IsUpper(name[0]))
                return name;

            var firstLatter = new[] { char.ToUpper(name[0], CultureInfo.InvariantCulture) };

            return new string(firstLatter.Concat(name.Skip(1)).ToArray());
        }
